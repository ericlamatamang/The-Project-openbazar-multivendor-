"""
Django settings for openbazar project.
...
SECRET_KEY = 'django-insecure-^bh-_(je*(k3i&i9-v@v+hz1m2@_z($!g@(70j2hj2=n3ytlo)'
...
WSGI_APPLICATION = 'openbazar.wsgi.application'
